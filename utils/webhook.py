...
async def _register_commands(bot):
    ...
    user_commands = [
        BotCommand(command="start",    description="📂 Open the content categories menu"),
        BotCommand(command="search",   description="🔍 Search for folders by name"),
        BotCommand(command="catalog",  description="📖 Browse the full content catalog"),
    ...
    admin_commands = user_commands + [
        ...
        BotCommand(command="newcategory",          description="🗂 Create a content category"),
        BotCommand(command="renamecategory",       description="✏️ Rename a category"),
        BotCommand(command="deletecategory",       description="🗑 Delete a category"),
        BotCommand(command="setcategoryemoji",     description="😀 Change category emoji"),
        BotCommand(command="movefolder",           description="📂 Move folder to a category"),
        BotCommand(command="removefoldercategory", description="📦 Unset a folder's category"),
        BotCommand(command="categories",           description="🗂 List all categories"),
        BotCommand(command="reordercategory",      description="🔢 Change category display order"),
        BotCommand(command="catalog",              description="📖 Generate/view the content catalog"),
        BotCommand(command="catalogurl",           description="🔗 Get the catalog URL"),
